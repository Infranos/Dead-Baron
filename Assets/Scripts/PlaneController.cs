...
public class PlaneController : MonoBehaviour {
    ...
    private GameObject _GameOverImage, _GameOverInstructions;
    ...
    void Start()
    {
        ...
        _GameOverImage = GameObject.FindGameObjectWithTag("GameOverImage");
        _GameOverInstructions = GameObject.FindGameObjectWithTag("GameOverInstructions");
    ...
    void OnTriggerEnter2D(Collider2D col) {
        ...
        if (col.gameObject.tag != "CandyCorn" && col.gameObject.tag!="HealthUp")
        {
            ...
            if (_playerHealth <= 0)
            {
                ...
                _gameIsActive = false;
                _GameOverImage.GetComponent<SpriteRenderer>().enabled = true;
                _GameOverInstructions.GetComponent<Text>().enabled = true;
    ...
    {
        _GameOverImage.GetComponent<SpriteRenderer>().enabled = false;
        _GameOverInstructions.GetComponent<Text>().enabled = false;
